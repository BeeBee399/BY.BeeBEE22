...
Subtitle.Text = "ผู้พัฒนาต่อจากGPTคนไทยNo.1"
...
Content.Position = UDim2.new(0, 105, 0, 55)
...
MinBtn.MouseButton1Click:Connect(function()
    ...
    -- Smooth animation
    local targetSize = minimized and UDim2.new(0, 420, 0, 50) or UDim2.new(0, 520, 0, 420)
...
local function CreateSidebarButton(text, yPos)
    ...
    Btn.MouseEnter:Connect(function()
        local tween = TweenService:Create(Btn, TweenInfo.new(0.2, Enum.EasingStyle.Quart), {BackgroundColor3 = Color3.fromRGB(50,50,70)})
        tween:Play()
    end)
    
    Btn.MouseLeave:Connect(function()
        local tween = TweenService:Create(Btn, TweenInfo.new(0.2, Enum.EasingStyle.Quart), {BackgroundColor3 = Color3.fromRGB(35,35,50)})
        tween:Play()
    end)
...
-- Enhanced button creation function with modern styling
local function CreateModernButton(parent, text, color, size)
    ...
    -- Hover effects
    btn.MouseEnter:Connect(function()
        local tween = TweenService:Create(btn, TweenInfo.new(0.2, Enum.EasingStyle.Quart), {BackgroundColor3 = Color3.fromRGB(math.min(255, color.R * 255 + 20), math.min(255, color.G * 255 + 20), math.min(255, color.B * 255 + 20))})
        tween:Play()
    end)
    
    btn.MouseLeave:Connect(function()
        local tween = TweenService:Create(btn, TweenInfo.new(0.2, Enum.EasingStyle.Quart), {BackgroundColor3 = color})
        tween:Play()
    end)
